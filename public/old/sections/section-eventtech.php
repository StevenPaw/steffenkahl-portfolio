<div class="section section--eventtech" id="eventtech">
    <div class="section_content">
        <h2>Event Technician</h2>
        <div class="description">
            <p>
                I started working with a friend of mine on a small startup to offer event tech for 
                small parties and events. For example we regularly lighten up the churches in
        ...
        <div class="et_examples">
            ...
            <a target="_blank" href="https://www.instagram.com/halloweenhaus.schmalenbeck/" class="et_example_wrap">
                <div class="et_example">
                    ...
                    <h4>2021</h4>
                    <h3>Halloweenhaus Schmalenbeck</h3>
            ...
            <a target="_blank" href="https://www.instagram.com/p/B6b1qYJIiJr/" class="et_example_wrap">
                <div class="et_example">
                    ...
                    <h4>2019</h4>
                    <h3>Rollerdisco</h3>
                    <p>A small party for the local inlineskate club of Ahrensburg</p>
                </div>
            </a>
        </div>
    </div>
