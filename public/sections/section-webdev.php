<div class="section section--webdev" id="webdev">
    <div class="section_content">
        <h2>Web Development</h2>
        <div class="description">
            <p>
                At the moment, I am employed at Adiwidjaja Teamworks GmbH in Ahrensburg, Germany where I create
                new and exciting websites. I also created some websites for customers of my self-employed work.
        ...
        <div class="wd_examples">
            ...
            <a href="https://sp-universe.com/" class="wd_example_wrap">
                <div class="wd_example">
                    ...
                    <h4>2020</h4>
                    <h3>SP Universe</h3>
                    <p>A website for all my business projects</p>
                </div>
            </a>
        </div>
    </div>
