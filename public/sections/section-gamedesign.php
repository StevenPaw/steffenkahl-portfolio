<div class="section section--reference-list" id="gamedesign">
    <div class="section_content">
        <h2 class="title">Gamedesign</h2>
        <div class="description">
            <p>
                I'm a GameDesign-Student at the University of Europe for Applied Sciences in Hamburg
        ...
        <div class="gd_examples">
            ...
            <a href="https://stevenpaw.itch.io/little-submarine" class="gd_example_wrap">
                ...
                <div class="gd_example">
                    ...
                    <h4>2021</h4>
                    <h3>Little Submarine</h3>
                    <p>A puzzle game created in less than 48 Hours in Unity. Little Submarine 2 is work in progress</p>
                </div>
            </a>
        </div>
    </div>
